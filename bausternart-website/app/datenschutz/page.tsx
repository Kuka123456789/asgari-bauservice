...
export const metadata: Metadata = {
  title: "Datenschutzerklärung - BAU STERN ART GmbH",
  description: "Datenschutzerklärung der BAU STERN ART GmbH. Informationen zum Datenschutz und zur Datenverarbeitung.",
};
    ...
    <div className="py-16 md:py-24">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h4 className="text-lg font-bold mt-4 mb-2">Wer ist verantwortlich für die Datenerfassung auf dieser Website?</h4>
          <p>
            Die Datenverarbeitung auf dieser Website erfolgt durch den Websitebetreiber. Dessen Kontaktdaten
            können Sie dem Impressum dieser Website entnehmen.
          </p>

          <h4 className="text-lg font-bold mt-4 mb-2">Wie erfassen wir Ihre Daten?</h4>
          <p>
          ...
          <h4 className="text-lg font-bold mt-4 mb-2">Wofür nutzen wir Ihre Daten?</h4>
          <p>
            Ein Teil der Daten wird erhoben, um eine fehlerfreie Bereitstellung der Website zu gewährleisten. Andere
            Daten können zur Analyse Ihres Nutzerverhaltens verwendet werden.
          </p>

          <h4 className="text-lg font-bold mt-4 mb-2">Welche Rechte haben Sie bezüglich Ihrer Daten?</h4>
          <p>
          ...
          <p>
            E-Mail: <a href="mailto:info@bausternart.de" className="text-blue-800 hover:underline">info@bausternart.de</a>
          </p>
          <p>
          ...
          <h3 className="text-xl font-bold mt-6 mb-3">Recht auf Datenübertragbarkeit</h3>
          <p>
          ...
          <h3 className="text-xl font-bold mt-6 mb-3">Recht auf Einschränkung der Verarbeitung</h3>
          <p>

      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold mb-4">BAU STERN ART GmbH</h3>
            <p className="text-gray-300 mb-4">
              Ihr Bauunternehmen für Neubau, Sanierung und Projektierung in Hamburg.
              Als Generalübernehmer begleiten wir Sie von der ersten Idee bis zur schlüsselfertigen Übergabe.
            </p>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} BAU STERN ART GmbH. Alle Rechte
            vorbehalten.
          </p>
